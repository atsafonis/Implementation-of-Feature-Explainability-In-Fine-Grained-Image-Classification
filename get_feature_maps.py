...
for data in trainloader:
    ...
    for i in range(input_tensor.shape[0]):
        ...
        np.save('/nfs/bigcortex/atsafonis/cub_classification/MMAL-Net/npy_saved_files_train_2/' + str(os.path.basename(os.path.normpath(rgb_input_path[i]))), input_list)
...
for data in testloader:
    ...
    for i in range(input_tensor.shape[0]):
        ...
        np.save('/nfs/bigcortex/atsafonis/cub_classification/MMAL-Net/npy_saved_files_test_2/' + str(os.path.basename(os.path.normpath(rgb_input_path[i]))), input_list)        
