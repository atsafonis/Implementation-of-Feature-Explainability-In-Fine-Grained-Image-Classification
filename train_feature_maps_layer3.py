...
trainset = FeatureMapsDataset(path = '/nfs/bigcortex/atsafonis/cub_classification/MMAL-Net/npy_saved_files_train_2/')
testset = FeatureMapsDataset(path = '/nfs/bigcortex/atsafonis/cub_classification/MMAL-Net/npy_saved_files_test_2/')
batch_size = 200
...
class BirdingNet(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1024, 768, 14)
        self.pool = nn.MaxPool2d(2, 2)
        self.conv2 = nn.Conv2d(768, 512, 5)
...
for epoch in range(0, num_epochs):
    ...
    if test_F1 > best_f1:
        best_f1 = test_F1
        torch.save(model.state_dict(), '/nfs/bigcortex/atsafonis/cub_classification/MMAL-Net/model_best_test_f1_layer3.pth')
        print("Saved")     
